package nl.jord1e.idea.pta.rules.lang.lexer;
...
//  {V_WS}                        { System.out.println("\n--------------------------"); yybeginl(S_MATCHER_MULTI); return EOL; }
}
...
//<S_MATCHER_MULTI> {
//  &[^\r\n]+                     { System.out.println("&:" + yytext()); yypushback(yylength() - 2); yybeginl(S_MATCHER_MULTI); return AND; }
//  %[^\r\n]+                     { System.out.println("%:" + yytext()); yypushback(yylength() - 1); yybeginl(S_IF_CSVFIELD); return PERCENT; }
//  [^\r\n]+                      { System.out.println("!!:" + yytext()); return REGEX; }
//  {V_WS}                        { System.out.println("NL:" + yytext().toString().replace("\r", "\\r").replace("\n", "\\n")); return EOL; }
//}
